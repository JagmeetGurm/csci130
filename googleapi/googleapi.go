...
const rootForm = `
  <!DOCTYPE html>
    <html>
      ...
      <body>
      <h1>Show Schools</h1>
        <form style="margin-left: 120px;" action="/school" method="post" accept-charset="utf-8">
...
func school(w http.ResponseWriter, r *http.Request) {
	...
	fullUrl := fmt.Sprintf(
		"https://maps.googleapis.com/maps/api/place/textsearch/xml?query=school+in+%s&key=AIzaSyD0nwU7DxevIexVJqoLCGy2rX2lred9568", addr1)
